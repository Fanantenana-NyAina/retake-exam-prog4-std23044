package com.retake.exam.endpoint.event.consumer;

import com.retake.exam.PojaGenerated;
import com.retake.exam.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.retake.exam.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.retake.exam.service.event."
